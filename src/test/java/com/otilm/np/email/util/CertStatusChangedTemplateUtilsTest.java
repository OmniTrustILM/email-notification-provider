...
""";
    ...
    public void testTemplateUtils() {
        String processedHtmlTemplate = TemplateUtils.renderHtml("email content", HTML_TEMPLATE, request);
    ...
    public void testTemplateUtilsSubject() {
        String processedSubject = TemplateUtils.renderPlainText("email subject", SUBJECT, request);
